...
# Use this code in src/help_test.py
atk_stats = []
atk_stats.append([6, 198, 15, 0.7317, 1.2, 1.6, 1.0])
def_stats = [1700, 85, 0.15]
bonus = 1.0
atk_seq = [0] * 13
```
...
# Use this code in src/help_test.py
atk_stats = []
atk_stats.append([6, 198, 14, 0.761563838, 1.2, 1.6, 1.0])
def_stats = [1700, 85, 0.15]
bonus = 1.0
atk_seq = [0] * 13
```
...
# Use this code in src/help_test.py
atk_stats = []
atk_stats.append([13, 239, 14, 0.7317, 1.2, 1.6, 1.0])
def_stats = [1700, 85, 0.15]
bonus = 1.0
atk_seq = [0] * 5
```
...
# Use this code in src/help_test.py
atk_stats = []
atk_stats.append([350, 167, 15, 0.8403, 1.2, 0.625, 1.0])
atk_stats.append([11, 60, 14, 0.5974, 1.0, 1.6, 1.0])
...
atk_stats.append([5, 76, 14, 0.517393947, 1.2, 1.0, 1.0])
...
atk_stats.append([5, 76, 11, 0.517393947, 1.2, 1.0, 1.0])
def_stats = [1700, 80, 0.15]
bonus = 1.0
atk_seq = [0] + [1] * 15
```
